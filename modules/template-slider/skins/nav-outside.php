...
class Nav_Outside extends \Elementor\Skin_Base {
    ...
    */
    public function get_title() {
        return __( 'Nav Outside', 'suprementor' );
    }
                ...
                <div uk-slider="<?php echo esc_attr( $settings['sup_slider_atts'] ); ?>">
                    ...
                    <div class="uk-position-relative">
                        ...
                        <?php if ( ! empty( $settings['sup_slidenav_show'] ) ) : ?>
                            ...
                            <span class="sup-slidenav uk-position-center-left-out uk-display-inline-block uk-hidden-touch <?php echo esc_attr( implode( ' ', $settings['sup_slidenav_classes']) ); ?>" href="#" uk-slidenav-previous uk-slider-item="previous"></span>
                            <span class="sup-slidenav uk-position-center-right-out uk-display-inline-block uk-hidden-touch <?php echo esc_attr( implode( ' ', $settings['sup_slidenav_classes']) ); ?>" href="#" uk-slidenav-next uk-slider-item="next"></span>
