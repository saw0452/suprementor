...
class Sub_Title_Overlay extends \Elementor\Skin_Base {
    ...
    */
    public function get_title() {
        return __( 'Sub Title Overlay', 'suprementor' );
    }
    ...
    */
    public function render() {
        ...
        <div class="uk-overflow-hidden uk-position-relative">
            ...
            <div class="uk-flex uk-flex-middle sup-card-inner sup-overlay <?php echo esc_attr( implode(' ', $settings['sup_overlay_classes']) ); ?>">
