    ...
    */
    public function render() {
        ...
        <?php else : ?>
            ...
            <?php \Suprementor\Controls\Doublet::open($settings, ['uk-flex', 'uk-flex-stretch']); ?>

            <?php \Suprementor\Controls\Doublet::first_column($settings, ['uk-cover-container']); ?>

            <?php \Suprementor\Controls\Post\Thumbnail::template( $post_id, $settings, true, ['class' => 'uk-cover', 'uk-cover' => 'true'] ); ?>

            <?php \Suprementor\Controls\Doublet::first_column_close(); ?>

            <?php \Suprementor\Controls\Doublet::second_column(); ?>
            ...
            <?php \Suprementor\Controls\Doublet::second_column_close(); ?>

            <?php \Suprementor\Controls\Doublet::close(); ?>
